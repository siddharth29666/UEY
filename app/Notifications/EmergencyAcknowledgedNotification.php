...
class EmergencyAcknowledgedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function via(object $notifiable): array
    {
        ...
        $type = NotificationType::EMERGENCY_ACKNOWLEDGED;

        $title = 'Emergency SOS Acknowledged';
        $body = 'SOS Alert has been acknowledged by the driver.';
