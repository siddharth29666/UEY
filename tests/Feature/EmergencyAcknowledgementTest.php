...
class EmergencyAcknowledgementTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_driver_can_acknowledge_sos()
    {
    ...
    public function test_driver_cannot_acknowledge_inactive_sos()
    {
        Sanctum::actingAs($this->driver, ['role:driver']);
        ...
        $response->assertStatus(500); // throws an exception
    }
}
